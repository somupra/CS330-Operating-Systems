...
int main(u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5)
{
    ...
    char* hpaddr1 = (char*)make_hugepage(paddr, 3*MB , 3, 1);
    pmap(1); // vm area 2
    ...
    for(u64 i = 0; i<4096; i+4096){ // one entry on each page, 1 page
        hpaddr1[i] = (char)('a' + i%26);
    }
     hpaddr1[1] = '\0';
    ...
    // printf("SECOND STR %s\n", (hpaddr1));
     ...
     for(u64 i = 0; i<4096; i+ 4096){ // one entry on each page, 512 pages
        printf("%c\n",hpaddr1[i]);
    }
